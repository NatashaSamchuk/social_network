...
const Friends = (props) => {
    ...
    let friendItem = friendFollow.map(element => <Friend key = {element.key} background = {element.background} foto = {element.foto} name = {element.name} from = {element.from} friends = {element.friends} numberFoto = {element.numberFoto} numberVideo = {element.numberVideo}/>);
